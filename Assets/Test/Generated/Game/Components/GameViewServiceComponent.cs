...
public partial class GameContext {
    ...
    public GameEntity SetViewService(Test.Services.IViewService newValue) {
        if (hasViewService) {
    ...
    public void ReplaceViewService(Test.Services.IViewService newValue) {
...
public partial class GameEntity {
    ...
    public void AddViewService(Test.Services.IViewService newValue) {
